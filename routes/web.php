...
$router->group(['prefix' => 'api/v1', 'as' => 'api.v1'], function () use ($router, $customRouter) {
    ...
    $router->group(['prefix' => 'public', 'as' => 'public'], function () use ($router) {
        ...
        $router->get('gallery-albums/{id}', ["as" => "public.recent.activities", "uses" => "GalleryAlbumController@clientSiteRead"]);
        $router->get('gallery-images-videos/{id}', ["as" => "public.recent.activities", "uses" => "GalleryImageVideoController@clientSiteRead"]);
    });
