...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'rabbitmq' => [
            'driver' => 'rabbitmq',
            'queue' => env('RABBITMQ_QUEUE','cms.q'),
            ...
            'options' => [
                'queue' => [
                    'exchange' => env('RABBITMQ_EXCHANGE_NAME','cms.x'),
                    'exchange_type' => env('RABBITMQ_EXCHANGE_TYPE','topic'),
                    'exchange_routing_key' => env('EXCHANGE_ROUTING_KEY','cms.routing.key'),
                ...
                'exchange' => [
                    'name' => env('RABBITMQ_EXCHANGE_NAME','cms.x'),
                ...
                'alternate_exchange' => [
                    'name' => env('RABBITMQ_ALTERNATE_EXCHANGE', 'cms.alternate.x'),
                    'type' => env('RABBITMQ_ALTERNATE_EXCHANGE_TYPE','fanout'),
                    'queue' => env('RABBITMQ_ALTERNATE_QUEUE','cms.alternate.q')
                ],
                'dlx' => [
                    'name' => env('RABBITMQ_RETRY_DLX', 'cms.dlx'),
                    'type' => env('RABBITMQ_RETRY_DLX_TYPE', 'fanout'),
                    'dlq' => env('RABBITMQ_RETRY_DLQ', 'cms.dlq'),
