...
class StaticPageBlocksSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('static_page_blocks')->insert([
            array('id' => '1','static_page_type_id' => '3','show_in' => '1','institute_id' => NULL,'organization_id' => NULL,'industry_association_id' => NULL,'title' => 'নাইস কিভাবে কাজ করে?','title_en' => NULL,'content' => '<p>নাইস একটি সম যার মাধ্যমে সরকার, শিল্প, প্রশিক্ষণ পরিষেবা এবং যুবসমাজের মধ্যে একটি ভারসাম্যপূর্ন সম্পর্ক স্থাপিত হয়।</p>','content_en' => NULL,'attachment_type' => '3','template_code' => 'PBT_LR','is_button_available' => '1','button_text' => 'বিস্তারিত পড়ুন','link' => NULL,'is_attachment_available' => '1','image_path' => NULL,'video_url' => 'https://www.youtube.com/watch?v=ZleQ9PmIVfU','video_id' => 'ZleQ9PmIVfU','image_alt_title_en' => NULL,'image_alt_title' => NULL,'created_by' => NULL,'updated_by' => NULL,'row_status' => '1','created_at' => '2022-01-11 06:39:17','updated_at' => '2022-02-10 02:26:57','deleted_at' => NULL),
            array('id' => '2','static_page_type_id' => '11','show_in' => '5','institute_id' => NULL,'organization_id' => NULL,'industry_association_id' => '1','title' => 'Page block','title_en' => NULL,'content' => '<div class="editor-template-table">
