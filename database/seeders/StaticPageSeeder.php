...
class StaticPageSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        StaticPageBlock::query()->truncate();
        for ($i = 0; $i < 10; $i++) {
            /** @var StaticPageBlock $staticPage */
            $staticPage = StaticPageBlock::factory()->create();
            CmsLanguage::factory()
                ->state(
                    new Sequence(
                        [
                            ...
                            'lang_code' => 'hi',
                            'column_name' => StaticPageBlock::LANGUAGE_ATTR_TITLE,
                        ...
                        [
                            ...
                            "key_id" => $staticPage->id,
                            'lang_code' => 'hi',
                            'column_name' => StaticPageBlock::LANGUAGE_ATTR_SUB_TITLE,
                        ...
                        [
                            ...
                            "key_id" => $staticPage->id,
                            'lang_code' => 'hi',
                            'column_name' => StaticPageBlock::LANGUAGE_ATTR_CONTENTS,
