...
class CalenderEventsController extends Controller
{
    ...
    public function createEventAfterInterviewScheduleAssign(Request $request): JsonResponse
    {
        $calenderEvent = $this->calenderEventService->createEventAfterInterviewScheduleAssign($request->toArray());
        $response = [
            'data' => $calenderEvent,
            '_response_status' => [
                "success" => true,
