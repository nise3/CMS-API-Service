...
class GalleryAlbumResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $response = [
            ...
            "batch_title" => $request->get(BaseModel::INSTITUTE_ORGANIZATION_INDUSTRY_ASSOCIATION_TITLE_BY_ID)[BaseModel::BATCH_AND_PROGRAM_TITLE][BaseModel::BATCH_TITLE][$this->batch_id]['title'] ?? "",
